...
<template>
  <XbModal :visible="visible && !!media" no-padding width="w-[48rem]" :show-close="true" @close="handleClose">
    <!-- Audio Player Content -->
    <div class="flex flex-col items-center px-8 py-10 bg-surface-overlay">
      <audio
        ref="audioRef"
        :src="media!.mediaUrl"
