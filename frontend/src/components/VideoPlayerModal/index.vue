  ...
  <XbModal :visible="visible && !!media" no-padding width="w-[70rem]" :show-close="true" @close="handleClose">
    <div class="flex h-[560px]">
      ...
      <div class="flex-1 min-w-0 flex flex-col">
        ...
        <!-- Info bar -->
        <div class="px-4 py-3 bg-surface-elevated border-t border-border flex-shrink-0">
      ...
      <div v-if="prompt || media!.episodes?.length" class="w-[25rem] border-l border-border bg-surface-elevated flex flex-col flex-shrink-0">
        ...
        <!-- Episode List -->
        <div v-if="media!.episodes?.length" class="flex flex-col flex-1 min-h-0">
